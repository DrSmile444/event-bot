...
const pollQuestionMessages = [
  '😎 Відпочиваємо сьогодні на Долині Троянд, {date}?',
  ...
  '🌞 Хто готовий змагатись у волейболі сьогодні, {date}? Граємо там, де більше подобається! 🏖️🏢',
  ...
  '🏐 Хто бажає грати у волейбол сьогодні, {date}, в Долині Троянд? Оберіть час та гайда грати на прекрасному майданчику серед троянд! 🌹🌹🌹',
  '🌃 Хто готовий зустріти захід сонця, граючи у волейбол у Долині Троянд сьогодні, {date}? Оберіть годину та гайда грати за яскравих барвистих заходів сонця! 🌅🏐',
  '🤾‍♀️ Хто бажає зіграти у волейбол з нашою командою сьогодні, {date}, в Долині Троянд? Оберіть час та гайда долучатись до гри та зважати нашу перемогу! 🤩🏐',
  '🏞️ Хто бажає зіграти у волейбол на природі сьогодні, {date}, в Долині Троянд? Оберіть час та гайда насолоджуватись чудовим краєвидом на мальовничій природі! 🌳🏐',
  '🏖️ Хто бажає зіграти у волейбол на природі сьогодні, {date}, в Долині Троянд? Оберіть час та гайда насолоджуватись грою! 🌊🏐',
  '🏐 Хто бажає зіграти у волейбол з новими людьми сьогодні, {date}, в Долині Троянд? Оберіть час та гайда зустрічатись з новими друзями на грі! 🤝🏐',
  '🏞️ Хто бажає зіграти у волейбол та піти на прогулянку в Долині Троянд сьогодні, {date}? Оберіть час та гайда насолоджуватись природою та грою! 🌹🏐',
  '🤼‍♂️ Хто бажає зіграти у волейбол та змагатись з нашою командою сьогодні, {date}, в Долині Троянд? Оберіть час та гайда показати свою спритність та силу! 💪🏐',
  '🌇 Хто бажає зіграти у волейбол та помандрувати разом з нами в Долину Троянд сьогодні, {date}? Оберіть час та гайда насолоджуватись грою та мальовничим краєвидом! 🌄🏐',
  '🏊‍♂️ Хто бажає зіграти у волейбол в Долині Троянд сьогодні, {date}? Оберіть час та гайда насолоджуватись грою та свіжістю води! 🏊‍♀️🏐',
];
